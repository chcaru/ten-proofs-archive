...
import ConnesRigidity.CertificateLiterals.PropertyTExactCertificateCoefficientEncodingLeaves.Part039A.Entry000
...
@[irreducible] noncomputable def coefficientSourceEncoding_039_a :
    Array Int :=
  (ConnesRigidity.CertificateLiterals.PropertyTExactCertificateCoefficientEncodingLeaves.Part039A.Entry000.data).getD 0 #[]

set_option maxHeartbeats 0 in

theorem coefficientEncodingLeafCheck_039_a :
    coefficientCheckData ((coefficientFactorTermChunk039).take 2125) =
      (coefficientSourceEncoding_039_a,
        590610353683664) := by
  unfold coefficientCheckData coefficientSourceEncoding_039_a
