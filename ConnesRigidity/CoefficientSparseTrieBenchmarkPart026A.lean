...
import ConnesRigidity.CertificateLiterals.CoefficientSparseTrieBenchmarkPart026A.Entry000
...
@[irreducible] noncomputable def coefficientSparseTrieExpectedPart026A :
    Array Int :=
  (ConnesRigidity.CertificateLiterals.CoefficientSparseTrieBenchmarkPart026A.Entry000.data).getD 0 #[]

set_option maxHeartbeats 0 in

theorem coefficientSparseTriePart026ACheck :
    sparseTrieNormalize
        ((coefficientFactorTermChunk026).take 2125) =
      sparseTermsOfIntPairs
        coefficientSparseTrieExpectedPart026A.toList := by
  unfold coefficientSparseTrieExpectedPart026A
